...
// set it.
#define data_lo() (gpio_put(ADB_PIN, 1))
#define data_hi() (gpio_put(ADB_PIN, 0))
#define data_in() (gpio_get(ADB_PIN))
#define adb_pin_out() (gpio_set_dir(ADB_PIN, GPIO_OUT))
#define adb_pin_in()  (gpio_set_dir(ADB_PIN, GPIO_IN))

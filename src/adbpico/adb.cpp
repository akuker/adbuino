...
static uint8_t kbdskip      = 0;
static uint16_t kbdprev0    = 0;
uint16_t mousereg0   = 0;
 uint16_t kbdreg0     = 0;
static uint8_t kbdsrq       = 0;
static uint8_t mousesrq     = 0;
static uint8_t modifierkeys = 0xFF;
static uint32_t kbskiptimer = 0;
